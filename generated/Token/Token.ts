...
export class Token extends ethereum.SmartContract {
  ...
  try_MAX_PUBLIC_MINT(): ethereum.CallResult<BigInt> {
  ...
  try_PRICE_PER_TOKEN(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "PRICE_PER_TOKEN",
      "PRICE_PER_TOKEN():(uint256)",
      []
  ...
  try_isAllowListActive(): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "isAllowListActive",
      "isAllowListActive():(bool)",
      []
  ...
  numAvailableToMint(addr: Address): i32 {
    let result = super.call(
      "numAvailableToMint",
      "numAvailableToMint(address):(uint8)",
  ...
  try_numAvailableToMint(addr: Address): ethereum.CallResult<i32> {
    let result = super.tryCall(
      "numAvailableToMint",
      "numAvailableToMint(address):(uint8)",
      [ethereum.Value.fromAddress(addr)]
...
export class SetIsAllowListActiveCall extends ethereum.Call {
  get inputs(): SetIsAllowListActiveCall__Inputs {
    return new SetIsAllowListActiveCall__Inputs(this);
  }

  get outputs(): SetIsAllowListActiveCall__Outputs {
    return new SetIsAllowListActiveCall__Outputs(this);
  }
}

export class SetIsAllowListActiveCall__Inputs {
  _call: SetIsAllowListActiveCall;

  constructor(call: SetIsAllowListActiveCall) {
    this._call = call;
  }

  get _isAllowListActive(): boolean {
    return this._call.inputValues[0].value.toBoolean();
  }
}

export class SetIsAllowListActiveCall__Outputs {
  _call: SetIsAllowListActiveCall;
